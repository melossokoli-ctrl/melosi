   ...
   <main className="min-h-screen">
      ...
      <section id="top" className="relative pt-32 pb-20 px-5">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.1fr_1fr] gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-accent text-accent-foreground px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest -rotate-2">
              <Flame size={14} aria-hidden />
              Hot Edition · New Name, Same Festival
            </div>
            ...
            <p className="mt-4 text-lg sm:text-xl text-muted-foreground max-w-xl">
              Festivali më i nxehtë në Kosovë. Tre netë muzikë, dritë e flakë në
              fushat e <span className="text-accent">Krushë e Madhe</span>.
            </p>
          ...
          <div className="relative">
            ...
            <img
              src="/assets/banner-CIZ1W5tI.jpg"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              Nga një festë e vogël fshatare në fushat e Krushës, deri te
              festivali më i ndjekur i verës. Kjo është udhëtimi ynë.
            </p>
          </div>
